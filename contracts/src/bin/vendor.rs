...
const NPM_CONTRACTS: &[(&str, &str)] = &[
    ...
    (
        "@gnosis.pm/ido-contracts@0.0.2/build/artifacts/contracts/test/ERC20Mintable.sol/ERC20Mintable.json",
        "ERC20Mintable.json",
    ),
    (
        "@gnosis.pm/ido-contracts@0.0.2/deployments/rinkeby/EasyAuction.json",
        "EasyAuction.json",
    ),
];

...
const NPM_CONTRACTS: &[(&str, &str)] = &[
    ...
    (
        "@gnosis.pm/ido-contracts@0.0.1-alpha.7/build/artifacts/contracts/test/ERC20Mintable.sol/ERC20Mintable.json",
        "ERC20Mintable.json",
    ),
    (
        "@gnosis.pm/ido-contracts@0.0.1-alpha.7/deployments/rinkeby/EasyAuction.json",
        "EasyAuction.json",
    ),
];
